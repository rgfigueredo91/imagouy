...
document.addEventListener("DOMContentLoaded", function(e){
    let language = {
        esp: {
            ...
            paragraph4:" Una vez confirmado que el modelo es correcto, los puntos de vistas seran chequeados con ustedes. Propondremos puntos de vista, sugiriendo la mejor seleccion. La intención es generar un hilo conductor entre imágenes para narrar de la mejor manera posible la propuesta. Estas imagenes muestran unicamente la espacialidad sin materiales, sin materiales(renders blancos). Se realiza una confirmación de los puntos de vista sobre los cual se trabajara mas adelante.",
            stage5:" ETAPA 5",
            overview:" Primera revisión",
            paragraph5:" En esta etapa se presenta la visualización completa, con materiales aplicados, luz y atmósferas elegidas. El cliente tendrá la posibilidad de hacer una lista de comentarios. La misma comentarios deberá ser muy precisa. Los comentarios referidos a luces, atmósfera, equipamiento, decoración y vegetación tienen que aparecer, todo lo que no sea comentado será entendio como aprobado por defecto.",
            stage6:" ETAPA 6",
            overview2:" Segunda revisión",
            paragraph6:" En esta etapa levantamos las observaciones realizadas en la etapa anterior, para asegurar que las expectativas fueron cumplidas. Este es el ultimo momento antes de renderizar la imagen en alta resolución.",
            stage7:" ETAPA FINAL",
